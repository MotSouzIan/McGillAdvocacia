  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="dashboard.php?r=entrar">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Data de Adimição</th>
            ...
            <div class="card-body">
                <form class="row g-3" method="POST" action="">
                    ...
                    <label for="inputCPF" class="form-label">CPF</label>
                      ...
                      <input type="text" class="form-control" name="cpf" id="inputCPF" maxlength="11" placeholder="000.000.000-00" required>
                      </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="cep" required name="cep" class="form-control" placeholder="00000-000" onblur="pesquisacep(this.value)" maxlength="8" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label for="rua" class="form-label">Nacionalidade</label>
                        <input type="text" required name="nacionalidade" id="nacionalidade" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label for="bairro" class="form-label">Profissão</label>
                        <input type="text" required name="profissao" id="profissao" class="form-control">
                    </div>
                    <div class="col-md-6">
                        <label for="cidade" class="form-label">Telefone Fixo</label>
                        <input type="text" id="telefoneFixo" required name="telefone" class="form-control" placeholder="(00)0000-0000" maxlength="10">
                    </div>
                    <div class="col-md-6">
                        <label for="estado" class="form-label">Estado Civil</label>
                        <input type="text" required name="estadoCivil" id="estadoCivil" class="form-control">
                    </div>
                    <div class="col-md-12">
...
if (!empty($_POST)) {
    ...
    $Nacionalidaade = $mysqli->real_escape_string($_POST['nacionalidade']);
    $Email = $mysqli->real_escape_string($_POST['email']);
    $Profissao = $mysqli->real_escape_string($_POST['profissao']);
    $TelFixo = $mysqli->real_escape_string($_POST['telefone']);
    ...
    $sql = "INSERT INTO cadfuncionarios (nome, cpf, estadoCivil, nacionalidade, email,  profissao, telefone, cep, endereco, dataNascimento, celular) 
                VALUES ('$Nome', '$CPF','$EstadoCivil', '$Nacionalidaade', '$email', '$profissao', '$TelFixo', '$Endereco', '$DataNascimento', '$Celular')";
